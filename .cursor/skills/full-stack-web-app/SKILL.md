...
description: Automatically builds complete, production-ready full-stack web applications from any idea or description. Use this skill when the user asks to build, create, develop, prototype, or make any type of web application, dashboard, platform, tool, SPA, or full-stack system. Works autonomously through all phases without questions, delivering production-quality code with comprehensive E2E testing, proper architecture, security, accessibility, and deployment configuration. Emphasizes rapid execution while maintaining high standards through automated testing and validation at every phase. Handles everything from simple CRUD apps to complex multi-feature platforms with auth, real-time features, analytics, admin panels, and more. Ideal for rapid prototyping and production-ready MVPs.
---
